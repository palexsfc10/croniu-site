...
const FAQ_ITEMS = [
  {
    ...
    question: "Funciona para quantos alunos?",
    answer:
      "O Croniu foi pensado para personal trainers com dezenas de alunos ativos — de quem está começando a crescer até quem já tem uma agenda cheia.",
  },
  {
    id: "instalar_aplicativo",
    question: "Preciso instalar algum aplicativo?",
    answer:
      "Não. O Croniu funciona direto no navegador, no computador ou no celular, sem precisar instalar nada.",
  },
  {
    id: "cartao_credito",
  ...
  {
    id: "ia_altera_dados",
    question: "A Cronia consegue alterar dados sozinha?",
    answer:
      "A Cronia responde perguntas com dados reais da sua conta (ciclos, recebimentos, agenda). Ações que mudam algo na sua operação sempre exigem sua confirmação explícita antes de acontecer.",
  },
];
