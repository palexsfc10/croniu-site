...
/**
 * Roteiro do demo. Cada cena é uma captura do produto REAL rodando: o
 * front-end de apps/web servido contra dados de demonstração fictícios
 * (Marina Prado e seus clientes não existem). Vale a mesma regra do
 * ProductScreenshot — nada de UI recriada ou inventada —, com a vantagem de
 * que recapturar é reexecutar o harness, não abrir um editor de imagem.
...
const SCENES: readonly [Scene, ...Scene[]] = [
  {
    ...
    alt: "Tela inicial do Croniu com os itens que precisam de decisão hoje, resumo financeiro do mês, clientes ativos e próximo compromisso",
    width: 3024,
    height: 1800,
    frame: "desktop",
    duration: 4600,
  },
  {
    ...
    alt: "Agenda do dia no Croniu, com os atendimentos posicionados na grade de horários, rotinas do dia e próximo compromisso",
    width: 3024,
    height: 1800,
    frame: "desktop",
    duration: 4200,
  },
  {
    id: "clientes",
    chapter: "Clientes",
    caption: "Quem você atende, com o próximo passo à vista.",
    src: "/images/demo/clientes.png",
    alt: "Lista de clientes do Croniu, com atendimento, próxima sessão, evolução, situação financeira e renovação de cada um",
    width: 3024,
    height: 1800,
    frame: "desktop",
    duration: 4200,
  },
  {
    ...
    alt: "Ciclos em andamento no Croniu, com período, progresso de sessões, data de renovação e situação financeira",
    width: 3024,
    height: 1800,
    frame: "desktop",
    duration: 4800,
  },
  {
    ...
    src: "/images/demo/financeiro.png",
    alt: "Tela financeira do Croniu, com recebido no mês, previsto, valores vencidos e a lista de cobranças",
    width: 3024,
    height: 1800,
    frame: "desktop",
    duration: 4400,
  },
  {
    ...
    alt: "Cronia no celular, oferecendo consultar o dia, os clientes em atenção e os ciclos terminando, com aviso de que nada é alterado sem confirmação",
    width: 1170,
    height: 2532,
    frame: "phone",
    duration: 5000,
...
export function ProductDemo() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Palco de proporção fixa, dimensionado para as capturas atuais
            (1.68:1 no desktop, 0.46:1 no celular): deixá-lo variar por cena
            empurraria o resto da página a cada troca. `container-type: size` deixa
          ...
          {SCENES.map((item, itemIndex) => {
            ...
            return (
              <div
                ...
                aria-hidden={!active}
                className={cn(
                  "absolute inset-0 flex items-center justify-center p-3 transition-opacity duration-500 ease-out sm:p-4",
                ...
                {item.frame === "phone" ? (
                  ...
                  <div
                    ...
                    style={{
                      ...
                      width: `min(100%, calc((100cqh - 3.5rem) * ${(item.width / item.height).toFixed(3)}))`,
